...
DEFAULT_MODULES="base,auth,users,billing,health-base,seed,rate-limit,audit,onboarding,notifications,api-keys,utils"
...
for arg in "$@"; do
  case "$arg" in
    ...
    --help)
      ...
      echo "Módulos disponibles: base, auth, users, billing, health-base, seed, rate-limit, audit, onboarding, notifications, api-keys, utils"
      echo "Flags:"
